...
import com.gjn.func.ConfigUtils;
import okhttp3.*;
...
/**
 * @Package com.gjn.utils.SiliconFlowApi
 * @Author jingnan.guo
 * @Date 2025/5/8 18:02
 * @description:
 */
public class SiliconFlowApi {
    ...
    private static final String SILICON_API_TOKEN = "sk-khrfeidbzpmevawkhorxuskfexhvkqieuvcwglkcumwlprab";
    ...
    public static String generateBadReview(String prompt, String apiToken) {
        try {
            ...
            Request request = new Request.Builder()
                    ...
                    .addHeader("Authorization", "Bearer " + "sk-khrfeidbzpmevawkhorxuskfexhvkqieuvcwglkcumwlprab")

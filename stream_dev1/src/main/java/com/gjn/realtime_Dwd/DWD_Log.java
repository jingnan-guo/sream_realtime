...
import com.gjn.utils.dataformtutil;
import com.gjn.utils.finksink;



/**
 * @Package com.gjn.realtime_Dwd.DWD_Log
 * @Author jingnan.guo
 * @Date 2025/4/9 22:56
 * @description: 处理log
 */
...
public class DWD_Log extends BaseApp {
    ...
    public void handle(StreamExecutionEnvironment env, DataStreamSource<String> kafkaStrDS) {
        OutputTag<String> log_dirty_data = new OutputTag<String>("dirtyTag"){};
        ...
        KafkaSink<String> log_dirty_data_dwd = finksink.getkafkasink("dirty_data");
        //脏数据发送kafka
